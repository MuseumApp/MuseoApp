...
public class Risorse {
    ...
    String [] descrizioniOggetti = {
            "Sepolture femminili di epoca Neolitica. Scheletri ritrovati in posizione fetale con corredi funebri tipicamente femminili. Tre aspetti importanti:-La posizione fetale ci indica la credenza nella vita ultraterrena -L’inumazione è testimonianza dell’esistenza di una ritualità complessa dei nostri antenati -Il corredo tombale, ci indica che si tratta di donne. Le decorazioni su di esso sono realizzate in ocra rossa e cipermettono la datazione risalente a circa 6200 anni fa",
            "statua di san michele arcangelo, 12 secolo, in pietra, tracce cromatiche un tempo colorata, braccio destro troncato, realizzato da scalpellini dell apietra bianca della maiella, è simbolo della continuità dei luoghi di culto in Abruzzo. Continuità dei luoghi di culto= sincretismo religioso. San Michele è un’entità guerriera, il trionfo del bene sul male. Sostituisce “ercole in assalto” nell’iconografia classica. Proprieta’ taumaturgica della pietra. Il cristianesimo sostituisce ercole con la statua di sm arcangelo che è l’entità più guerriera del nostro cristianesimo. La statua di S.M. è stata ritrovata spesso nelle grotte, veniva sistemata li come pegno dai pastori prima di partire per la transumanza per richiesta di protezione per i viaggi pericolosi. S.M. è simbolo di atteggiamento di ringraziamento.",
            "Presente in molte feste abruzzesi è simbolo della persistenza nella contemporaneità di un culto propiziatorio per la fertilità della terra, A cappelle è la più emblematica. Scopo propiziatorio, antico rito pastorale.",
            "Artigianato ligneo pastorale risalente agli anni 30 del 900 con firma emidio di gulielmo (palena), specchio da toletta dono di nozze per la nipote.",
            "Cesoie in ferro a molla, realizzate in un unico pezzo utilizzate per la tosatura. Attrezzo indispensabile del mondo pastorale.",
            "Tholos ricovero in pietra a secco della majella,tecnica di costruzione senza leganti, sono pietre incastrate tra loro, usato in contesto agro-pastorale, la forma deriva da preesistenti architetture pugliesi. Ricovero temporaneo durante i mesi estivi.",
            "Aratro E’ del 19° secolo in legno, è presente in fonti iconografiche di epoca neolitica con coppia di buoi  aggiogati. E’ un oggetto che mostra la continuità della nostra tradizione agricola.",
            ...
            "",//yhesss
            "Mesa o Madia E’ un  oggetto dell’artigianato domestico agropastorale, … domestica. Utilizzata per far lievitare e conservare il pane realizzata con elementi in legno inseriti ad incastro, è smontabile per essere trasportata in eventuali spostamenti.",
            "Telaio È lo strumento più importante nel processo di realizzazione dei tessuti. In inverno le donne realizzavano tutti i tessuti necessari alla vita domestica, utilizzato fino a metà del 20° secolo, la tessitura manuale è una delle tradizioni artigianali più antiche d’Abruzzo. Ben visibili i fili dell’ordito su cui la tessitrice inseriva il filo di trama per realizzare la tela",
            "Gioiello realizzato in filigrana, ciondolo propiziatorio per la fertilià ed è di buon auspicio per l’unione della coppia. E’ uno dei gioielli più antichi e noti dell’oreficeria Abruzzese. Veniva donato da un pastore alla sua sposa prima della partenza per la transumanza. E’ il pegno di fidanzamento che prelude al matrimonio che sarebbe avvenuto al rientro dalla transumanza. Al centro vi è la rappresentazione di due cuori legati da un crescente lunare, simbolo della fertilità. Inoltre gli astri sono elementi tipici dell’artigianato artistico popolare. Fanno da coronamento all’oggetto i raggi solari il cui numero dipendeva dalle disponibilità economiche del pastore. Realizzato in oro a bassa caratura e in rame per abbassare i costi.",
            "Mattone prelevato dalla chiesa di San Donato di Castelli, “La Cappella Sistina della Maiolica”Carlo Levi 1936. Costituiva parte del soffitto cinquecentesco della chiesa. Rappresenta una donna di profilo, detta “la bella”, in abiti rinascimentali risalente al IV decennio del XVI secolo. E’ esemplificativa dei canoni di bellezza del Rinascimento. I colori, il blu cobalto, il giallo, il verde, il marrone e l’arancio sono tipici delle maioliche di Castelli.",
            "!!! da cambiare !!!  è la sala de Caesaris, catene",
    };
