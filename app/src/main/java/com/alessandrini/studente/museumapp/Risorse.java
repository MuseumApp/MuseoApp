...
import android.media.Image;
    ...
    String [] descrizioniOggetti = {
            "Sepolture femminili di epoca Neolitica, gli scheletri sono stati ritrovati in posizione fetale con corredi funebri tipicamente femminili, osservando la composizione gli aspetti più importanti sono: la posizione fetale che ci indica la credenza nella vita ultraterrena, l’inumazione che è testimonianza dell’esistenza di una ritualità complessa dei nostri antenati e infine il corredo tombale che ci permette di capire che si tratta di donne. Le decorazioni su di esso sono realizzate in ocra rossa e ci permettono la datazione risalente a circa 6200 anni fa",
            "Statua di San Michele arcangelo risalente al XII secolo realizzata in pietra, grazie alle tracce tracce cromatiche residue si è certi che un tempo fosse colorata. La statua è stata realizzata da scalpellini della pietra bianca della maiella ed è simbolo della continuità dei luoghi di culto in Abruzzo. San Michele è un’entità guerriera e rappresenta il trionfo del bene sul male perciò nell’iconografia classica rappresenta l'entità più guerriera del cristianesimo. La statua di San Michele è stata ritrovata spesso nelle grotte, veniva sistemata li come pegno dai pastori prima di partire per la transumanza come richiesta di protezione per i viaggi pericolosi.",
            "La Pupa, presente in molte feste abruzzesi è simbolo della persistenza nella contemporaneità di un culto propiziatorio per la fertilità della terra e veniva utilizzata per antichi riti pastorali. Nella contemporaneità viene fatta sfilare, talvolta su dei carri allegorici e a Cappelle sul Tavo, un piccolo comune nel pescarese, c'è una delle sfilate più emblematiche.",
